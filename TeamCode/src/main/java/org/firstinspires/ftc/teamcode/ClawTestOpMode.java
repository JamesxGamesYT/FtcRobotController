    ...
    @Override
        public void runOpMode() {
            ...
            while (opModeIsActive()) {//loop this until stop button is pressed
                ...
                telemetry.addData("Claw info", "State: " + robot.desiredClawState + "; Servo position: " + robot.claw.getPosition() + ";"); //Was there something about how a servo with a position could not be used here?
                telemetry.update();
            }
        }
}
